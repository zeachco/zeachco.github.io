...
export const skills: SkillData[] = [
  ...
  },
  {
    ...
    start: '2020-08',
    percent: 65,
    labels: ['programming', 'client', 'server', 'llm', 'ai'],
  ...
  },
  {
    ...
    percent: 80,
    labels: ['domain'],
    note: 'Game development spanning browser-based HTML5/WebGL titles and multiplayer poker platforms. Led the World Series of Poker project at Playtika and built independent game engines using canvas, physics, and AI simulation.',
    score: { frontend: 0.8, backend: 0.7, techlead: 0.8, management: 0.5 },
  },
  {
    name: 'Telecoms',
    start: '2009-05',
    percent: 60,
    labels: ['domain'],
    note: 'Enterprise software and middleware for Videotron and Québecor, including ESB/EAI integration, Software AG platforms, and internal tooling across multi-environment telecoms infrastructure.',
    score: { frontend: 0.5, backend: 0.7, techlead: 0.7, management: 0.6 },
  },
  {
    name: 'Events',
    start: '2013-10',
    percent: 55,
    labels: ['domain'],
    note: 'Ticketing and event management platforms including Ticketpro and the Festival International d\'été de Québec 2013, covering front-end development and SWT-based ticket selling software.',
    score: { frontend: 0.7, backend: 0.6, techlead: 0.6, management: 0.4 },
  },
  {
    name: 'Banking',
    start: '2014-10',
    percent: 65,
    labels: ['domain'],
    note: 'Financial services software at Morgan Stanley and Chase, including compliance tooling, Splunk integrations, complex form systems for Shopify Payments, and certified training in trading and anti-corruption standards.',
    score: { frontend: 0.6, backend: 0.7, techlead: 0.7, management: 0.6 },
  },
  {
    name: 'Ecommerce',
    start: '2015-03',
    percent: 75,
    labels: ['domain'],
    note: 'White-label marketplace platforms at AppDirect, affiliate and hotel booking integrations at Stay22, and retail ecommerce pipeline work including ML-driven monetisation and third-party affiliation systems.',
    score: { frontend: 0.8, backend: 0.8, techlead: 0.8, management: 0.5 },
  },
  {
    name: 'Security',
    start: '2019-11',
    percent: 80,
    labels: ['domain'],
    note: 'Security-first engineering across Shopify Payments (PCI-compliant form infrastructure), Pod (auth layers over Firebase/MySQL/Postgres), and Stay22 (security training programs, dependency audits, CI/CD hardening).',
    score: { frontend: 0.7, backend: 0.9, techlead: 0.9, management: 0.6 },
  },
  {
    name: 'Fintech',
    start: '2019-11',
    percent: 70,
    labels: ['domain'],
    note: 'Payments infrastructure at Shopify, personal finance tracking application Yenom (200+ users, AI-driven counselling), and financial analytics at Morgan Stanley. Experience covers compliance, transaction flows, and ML-based financial insights.',
    score: { frontend: 0.7, backend: 0.8, techlead: 0.8, management: 0.6 },
  },
  {
    name: 'Startups',
    start: '2023-02',
    percent: 90,
    labels: ['domain'],
    note: 'Founding-team-level contributions at Yenom and Pod: full ownership of architecture, DevOps, design systems, and product delivery. Comfortable operating across all layers of the stack with minimal process overhead.',
    score: { frontend: 0.9, backend: 0.9, techlead: 0.9, management: 0.7 },
  },
].map((s: any) => {
  return {
    ...s,
